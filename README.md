...
- **Proxy loading**: Load as dxgi.dll, d3d11.dll, d3d12.dll, dinput8.dll, hid.dll, bcrypt.dll, version.dll, opengl32.dll, dbghelp.dll, or vulkan-1.dll proxy when needed
