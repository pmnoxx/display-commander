@echo off
REM Copy Display Commander 64-bit addon to the proxy DLL names that DC supports (d3d9, d3d11, d3d12, ddraw, dinput8, hid, opengl32, dxgi, version, winmm, dbghelp, vulkan-1).
