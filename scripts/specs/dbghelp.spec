# Wine dbghelp.spec - https://github.com/wine-mirror/wine/blob/master/dlls/dbghelp/dbghelp.spec
# Used by: python scripts/gen_proxy_from_spec.py dbghelp scripts/specs/dbghelp.spec
...
@ stdcall SymGetLineFromNameW64(long wstr wstr long long ptr ptr)
