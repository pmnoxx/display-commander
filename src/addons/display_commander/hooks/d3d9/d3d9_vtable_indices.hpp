...
// The vtable layout is defined by the override order in external/reshade/source/d3d9/d3d9_device.hpp
// (IUnknown 22-24, IDirect3DDevice9 26-131, IDirect3DDevice9Ex 144-157). This enum mirrors that order.
// Use when hooking device vtable slots (e.g. vtable[VTable::Present]).

namespace display_commanderhooks::d3d9 {

enum VTable : unsigned int {
    // IUnknown (0-2)
    QueryInterface = 0,
    AddRef = 1,
    Release = 2,
