...
std::string HookSuppressionManager::GetSuppressionSettingName(HookType hookType) {
    switch (hookType) {
        ...
        case HookType::TIMESLOWDOWN:         return "SuppressTimeslowdownHooks";
        case HookType::DEBUG_OUTPUT:         return "SuppressDebugOutputHooks";
        case HookType::LOADLIBRARY:          return "SuppressLoadLibraryHooks";
...
std::string HookSuppressionManager::GetInstallationSettingName(HookType hookType) {
    switch (hookType) {
        ...
        case HookType::TIMESLOWDOWN:         return "TimeslowdownHooksInstalled";
        case HookType::DEBUG_OUTPUT:         return "DebugOutputHooksInstalled";
        case HookType::LOADLIBRARY:          return "LoadLibraryHooksInstalled";
