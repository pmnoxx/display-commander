...
ui::new_ui::SettingBase* GetSuppressionSetting(HookType hookType) {
    switch (hookType) {
        ...
        case HookType::VULKAN:
            return &settings::g_hook_suppression_settings.suppress_vulkan_hooks;
...
bool HookSuppressionManager::ShouldSuppressHook(HookType hookType) {
    ...
    switch (hookType) {
        ...
        case HookType::VULKAN:
            return settings::g_hook_suppression_settings.suppress_vulkan_hooks.GetValue();
        case HookType::HID_SUPPRESSION:
...
bool HookSuppressionManager::WasHookInstalled(HookType hookType) {
    switch (hookType) {
        ...
        case HookType::VULKAN:
            return settings::g_hook_suppression_settings.vulkan_hooks_installed.GetValue();
        case HookType::HID_SUPPRESSION:
