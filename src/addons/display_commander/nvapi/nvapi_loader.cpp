...
bool Load() {
    ...
    g_ptrs.SYS_GetDriverAndBranchVersion = Query<NvAPI_SYS_GetDriverAndBranchVersion_pfn>(query, ID_SYS_GetDriverAndBranchVersion);
    g_ptrs.DISP_GetAdaptiveSyncData = Query<NvAPI_DISP_GetAdaptiveSyncData_pfn>(query, ID_DISP_GetAdaptiveSyncData);
    g_ptrs.DISP_GetDisplayIdByDisplayName = Query<NvAPI_DISP_GetDisplayIdByDisplayName_pfn>(query, ID_DISP_GetDisplayIdByDisplayName);
    ...
    g_ptrs.DRS_EnumAvailableSettingIds = Query<NvAPI_DRS_EnumAvailableSettingIds_pfn>(query, ID_DRS_EnumAvailableSettingIds);
    g_ptrs.DRS_EnumAvailableSettingValues = Query<NvAPI_DRS_EnumAvailableSettingValues_pfn>(query, ID_DRS_EnumAvailableSettingValues);
...
const NvApiPtrs* Ptrs() {
    return g_loaded.load(std::memory_order_acquire) ? &g_ptrs : nullptr;
}
