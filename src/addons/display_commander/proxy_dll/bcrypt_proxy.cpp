 ...
 * the SDK declarations (C2733 on x86). We include Windows.h with WIN32_LEAN_AND_MEAN first
 * so that any later inclusion of windows.h (e.g. from timing.hpp) does not pull in the full
 * set of headers that might bring in bcrypt.h.
 */
