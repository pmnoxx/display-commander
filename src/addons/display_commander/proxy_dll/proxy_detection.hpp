...
// Detect if Display Commander is being loaded as a proxy DLL (ddraw.dll, dxgi.dll, d3d11.dll, d3d12.dll, or version.dll)
...
inline bool IsProxyDllMode(HMODULE h_module = nullptr)
{
	...
	// Check if we're being loaded as ddraw.dll, dxgi.dll, d3d11.dll, d3d12.dll, or version.dll
	return module_name == L"ddraw.dll" || module_name == L"dxgi.dll" || module_name == L"d3d11.dll" ||
	       module_name == L"d3d12.dll" || module_name == L"version.dll";
}
