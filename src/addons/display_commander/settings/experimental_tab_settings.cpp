...
ExperimentalTabSettings::ExperimentalTabSettings()
    : auto_click_enabled("AutoClickEnabled", false, "DisplayCommander.Experimental"),
      ...
      perf_measure_overlay_show_volume_enabled("PerfMeasureOverlayShowVolumeEnabled", true, "DisplayCommander.Experimental"),
      perf_measure_overlay_show_vrr_status_enabled("PerfMeasureOverlayShowVrrStatusEnabled", true, "DisplayCommander.Experimental"),
      ...
      perf_measure_handle_present_after_enabled("PerfMeasureHandlePresentAfterEnabled", true,
                                                "DisplayCommander.Experimental"),
      perf_measure_flush_command_queue_from_swapchain_enabled("PerfMeasureFlushCommandQueueFromSwapchainEnabled", true,
                                                              "DisplayCommander.Experimental"),
      ...
      perf_suppress_flush_command_queue_from_swapchain("PerfSuppressFlushCommandQueueFromSwapchain", false,
                                                       "DisplayCommander.Experimental"),
    ...
    all_settings_ = {
        ...
        &hid_suppression_enabled,
        &hid_suppression_dualsense_only,
        &hid_suppression_block_readfile,
        &hid_suppression_block_getinputreport,
