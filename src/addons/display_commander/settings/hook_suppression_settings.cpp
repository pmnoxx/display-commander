...
HookSuppressionSettings::HookSuppressionSettings()
    ...
    : suppress_dxgi_factory_hooks("DxgiFactoryHooks", false, "DisplayCommander.HookSuppression"),
      ...
      suppress_hid_kernel32_hooks("HidKernel32Hooks", false, "DisplayCommander.HookSuppression"),
      suppress_hid_hid_dll_hooks("HidHidDllHooks", false, "DisplayCommander.HookSuppression"),
      ...
      dinput8_hooks_installed("DInput8Hooks", false, "DisplayCommander.HooksInstalled"),
      ...
      hid_kernel32_hooks_installed("HidKernel32Hooks", false, "DisplayCommander.HooksInstalled"),
      hid_hid_dll_hooks_installed("HidHidDllHooks", false, "DisplayCommander.HooksInstalled"),
    ...
    all_settings_ = {
        ...
        &suppress_dinput8_hooks,
        &suppress_streamline_hooks,
        &suppress_ngx_hooks,
        &suppress_windows_gaming_input_hooks,
        &suppress_hid_kernel32_hooks,
        &suppress_hid_hid_dll_hooks,
        &suppress_api_hooks,
        ...
        &dinput8_hooks_installed,
        &streamline_hooks_installed,
        &ngx_hooks_installed,
        &windows_gaming_input_hooks_installed,
        &hid_kernel32_hooks_installed,
        &hid_hid_dll_hooks_installed,
        &api_hooks_installed,
