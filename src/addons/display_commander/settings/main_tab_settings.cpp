...
MainTabSettings::MainTabSettings()
    : window_mode(
      ...
      experimental_safe_mode_fps_limiter("safe_mode_fps_limiter", false, "DisplayCommander"),
      ...
      brightness_autohdr_section_enabled("brightness_autohdr_section_enabled", true, "DisplayCommander"),
    ...
    all_settings_ = {
        ...
        &prevent_tearing,
        &limit_real_frames,
        &increase_backbuffer_count_to_3,
