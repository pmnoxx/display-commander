...
class MainTabSettings {
   public:
    ...
    /** FPS limiter preset when game has native Reflex. 0=Balanced, 1=Stability, 2=Low-latency (max queued=1),
...
// Utility functions
/** Applies FPS limiter preset values (0-5). Preset 6 = Custom, no apply. */
