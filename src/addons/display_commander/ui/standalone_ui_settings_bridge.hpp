...
/** Non-null when this process is showing the standalone Games/Settings window (exe or rundll32 Launcher). Use to hide "Open Games UI (standalone)" when already in that window. */
